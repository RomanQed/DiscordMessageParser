...
public class CustomListenerAdapter extends ListenerAdapter {
    ...
    public CustomListenerAdapter() throws ClassNotFoundException, InvocationTargetException, InstantiationException, IllegalAccessException {
        CommandList commandList = new CommandList(BotCommandAnnotationParser.getCommandList());
        IParseEventHandler eventHandler = new EventHandler();
    ...
    public void onGuildMessageDelete(@NotNull GuildMessageDeleteEvent event) {
        parser.processGuildMessageDelete(event);
    }

    @Override
    public void onPrivateMessageDelete(@NotNull PrivateMessageDeleteEvent event) {
        parser.processPrivateMessageDelete(event);
    }
}
